...
public class SeaTunnelJob {
    ...
    private final static String EXECUTE_COMMAND = "nohup bin/seatunnel.sh -m cluster --config config/%s  -r %s > logs/%s 2>&1 &";
    ...
    private String getLogFileName() {
        return this.fileName
                .substring(0, this.fileName.lastIndexOf(".")).concat(".log");
    }
}
