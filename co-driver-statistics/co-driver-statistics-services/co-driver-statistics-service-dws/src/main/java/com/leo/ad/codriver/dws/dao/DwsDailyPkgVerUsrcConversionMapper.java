...
public interface DwsDailyPkgVerUsrcConversionMapper extends BaseMapper<DwsDailyPkgVerUsrcConversion> {
    ...
    List<DwsDailyPkgVerUsrcConversion> queryActiveList(@Param("dates") Integer dates);

    List<DwsDailyPkgVerUsrcConversion> queryNewList(@Param("dates") Integer dates);

    List<DwsDailyPkgVerUsrcConversion> queryDbList(@Param("dates") Integer dates);
}
