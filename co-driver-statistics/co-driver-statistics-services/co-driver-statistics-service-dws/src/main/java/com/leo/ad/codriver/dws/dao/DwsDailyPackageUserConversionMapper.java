...
public interface DwsDailyPackageUserConversionMapper extends BaseMapper<DwsDailyPackageUserConversion> {
    ...
    List<DwsDailyPackageUserConversion> statisticsActiveList(@Param("dates") Integer dates);

    List<DwsDailyPackageUserConversion> statisticsNewList(@Param("dates") Integer dates);
}
