...
/**
 *
 * @TableName dws_daily_pkg_usrc_ad
 */
@TableName(value = "dws_daily_pkg_usrc_ad")
@Data
public class DwsDailyPkgUsrcAd implements BaseEntity {
    /**
     * 主键id
     */
    ...
    public String getUniqueId() {
        return String.format("%s_%s", pkg, userSource);
    }
