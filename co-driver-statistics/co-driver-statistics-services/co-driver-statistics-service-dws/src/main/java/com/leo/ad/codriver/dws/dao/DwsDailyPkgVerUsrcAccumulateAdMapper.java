...
@Mapper
@DS("mysql")
public interface DwsDailyPkgVerUsrcAccumulateAdMapper extends BaseMapper<DwsDailyPkgVerUsrcAccumulateRegister> {

    List<DwsDailyPkgVerUsrcAccumulateRegister> queryDbList(@Param("dates") Integer dates);
}
