 ...
 * dws每日用户版本事件统计
 *
 * @TableName dws_daily_pkg_ver_ad_conversion_event
 */
@TableName(value = "dws_daily_pkg_ver_ad_conversion_event")
@Data
public class DwsDailyPkgVerAdConversionEvent implements Serializable {
    /**
     * 主键ID
     */
    ...
    public DwsDailyPkgVerAdConversionEvent() {
    ...
    public static DwsDailyPkgVerAdConversionEvent ofNewUserType(Integer dates, String pkg, String version) {
        DwsDailyPkgVerAdConversionEvent dwsDailyPkgVerAdConversionEvent = new DwsDailyPkgVerAdConversionEvent();
    ...
    public static DwsDailyPkgVerAdConversionEvent ofActiveUserType(Integer dates, String pkg, String version) {
        DwsDailyPkgVerAdConversionEvent dwsDailyPkgVerAdConversionEvent = new DwsDailyPkgVerAdConversionEvent();
        dwsDailyPkgVerAdConversionEvent.setDates(dates);
        dwsDailyPkgVerAdConversionEvent.setPkg(pkg);
        dwsDailyPkgVerAdConversionEvent.setVersion(version);
