...
/**
 *
 * @TableName dws_daily_cohort_pkg_advertising
 */
@TableName(value = "dws_daily_cohort_pkg_advertising")
@Data
public class DwsDailyCohortPkgAdvertising implements BaseEntity {
