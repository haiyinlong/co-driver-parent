...
@Mapper
@DS("mysql")
public interface DwsDailyPkgUsrcAccumulateAdMapper extends BaseMapper<DwsDailyPkgUsrcAccumulateRegister> {

    List<DwsDailyPkgUsrcAccumulateRegister> queryDbList(@Param("dates") Integer dates);
}
