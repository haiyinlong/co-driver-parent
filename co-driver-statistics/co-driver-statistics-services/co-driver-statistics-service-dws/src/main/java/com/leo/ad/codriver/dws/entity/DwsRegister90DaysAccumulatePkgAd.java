...
@Data
public class DwsRegister90DaysAccumulatePkgAd implements Serializable, BaseEntity {
    /**
     * 主键ID
     */
    ...
    private void addAccumulate(DwsRegister90DaysAccumulatePkgAd advertisingValue) {
    ...
    public void copyAdvertisingValue(DwsRegister90DaysAccumulatePkgAd advertisingValue) {
