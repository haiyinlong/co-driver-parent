...
public class CohortUserAnalysePkgReportService {
    ...
    public void syncData(Integer dates) {
        ...
        List<AdsDailyUserQualityAnalyse> list =
            adsDailyUserQualityAnalyseMapper.queryCohortUserAnalysePkgReportList(dates);
        ...
        // 计算同期群1-7的数据
        List<TempDailyUserQualityAnalyse> day1To7List = adsDailyUserQualityAnalyseMapper.queryPkgCohortD1ToD7(dates);
        tempBatchMapper.batchInsert(day1To7List, TempDailyUserQualityAnalyseMapper.class);
        // 计算同期群8-14的数据
        List<TempDailyUserQualityAnalyse> day8To14List = adsDailyUserQualityAnalyseMapper.queryPkgCohortD8ToD14(dates);
        ...
        List<TempDailyUserQualityAnalyse> day15To30List =
            adsDailyUserQualityAnalyseMapper.queryPkgCohortD15ToD30(dates);
